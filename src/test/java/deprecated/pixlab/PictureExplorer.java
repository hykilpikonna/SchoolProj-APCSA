...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
    ...
    /**
     * deprecated.gridworld.Test Main.  It will explore the beach
     */
    ...
    private void createAndInitPictureFrame()
    {
        ...
        // MODIFIED
        /*pictureFrame.addKeyListener(new KeyAdapter()
        {
            @Override
    ...
    private void setUpNextAndPreviousButtons()
    {
        ...
        Icon prevIcon = new ImageIcon(getClass().getResource("/leftArrow.gif"), "previous index");
        Icon nextIcon = new ImageIcon(getClass().getResource("/rightArrow.gif"), "next index");
        ...
        colPrevButton.addActionListener(evt ->
        {
            colIndex--;
            if (colIndex < 0)
                colIndex = 0;
        ...
        rowPrevButton.addActionListener(evt ->
        {
            rowIndex--;
            if (rowIndex < 0)
                rowIndex = 0;
        ...
        colNextButton.addActionListener(evt ->
        {
            colIndex++;
        ...
        rowNextButton.addActionListener(evt ->
        {
            rowIndex++;
    ...
    public JPanel createLocationPanel(Font labelFont)
    {
        ...
        // create the labels
        rowLabel = new JLabel("Y:");
        colLabel = new JLabel("X:");

        // create the text fields
        colValue = new JTextField(Integer.toString(colIndex + numberBase), 6);
        colValue.addActionListener(e -> displayPixelInformation(colValue.getText(), rowValue.getText()));
        rowValue = new JTextField(Integer.toString(rowIndex + numberBase), 6);
        rowValue.addActionListener(e -> displayPixelInformation(colValue.getText(), rowValue.getText()));
